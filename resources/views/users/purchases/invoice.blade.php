...
@section('user_content')
  ...
  <div class="card shadow mb-4">
      <div class="card-header py-3">
        ...
        <div class="card-body">
          ...
          <div class="row clearfix justify-content-md-center">
            <div class="col-md-9">
              <div class="no_padding no_margin">Supplier:{{ $user->name }}</div>
          ...
          <div class="invoice_items">
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$item->total}}</td>
                  <td class="text-right">
                    <form action="{{route('user.purchases.delete_item',['id' => $user->id, 'invoice_id' =>$invoice->id, 'item_id' =>$item->id])}}"
                      method="POST">
                    @csrf
                    @method('DELETE')
            ...
            <tr>
              ...
              <tr>
                ...
                <th>
                   <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#newPaymentForInvoice">
    ...
    {{-- modal for add new payments for invoice --}}
    ...
    <div class="modal fade" id="newPaymentForInvoice" tabindex="-1" role="dialog" aria-labelledby="newPaymentForInvoiceModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        ...
        {!! Form::open(['route' => ['user.payments.store', ['id'=>$user->id, 'invoice_id'=>$invoice->id] ], 'method' => 'post']) !!}


        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="newPaymentForInvoiceModalLabel">New Payment</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
